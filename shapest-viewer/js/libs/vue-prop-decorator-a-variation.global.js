/**
  * vue-prop-decorator-a-variation v0.3.0
  * (c) 2021-present Dimava
  * @license MIT
  */
var VuePropDecoratorAVariation = (function (exports, vue) {
  'use strict';
  ...
  function Template(target, propertyKey, descriptor) {
    ...
    if (descriptor) {
      ...
      value = (_ref = (_descriptor$value = descriptor.value) !== null && _descriptor$value !== void 0 ? _descriptor$value : descriptor.get) !== null && _ref !== void 0 ? _ref : '';
    } else {
  ...
  var knownComponents = {};
  function registerKnownComponents(app) {
    for (var k in knownComponents) {
  ...
  exports.known = known;
  exports.knownComponents = knownComponents;
  exports.makeClass = makePropClass;
  exports.registerKnownComponents = registerKnownComponents;
