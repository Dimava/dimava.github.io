...
import { FnBuilding } from "./fn-buildings.js";
import { Entity, enumItemProcessorTypes, GameRoot, Mod, MOD_ITEM_PROCESSOR_HANDLERS, MOD_ITEM_PROCESSOR_SPEEDS, ShapeItem } from "./types/shapez.js";

export const METADATA: shapez.ModMetadata = {
	website: "",
	author: "Dimava",
	name: "TS test",
	version: "1.0.0",
...
export default class ModImpl extends Mod {
	...
	use(module: { install: (mod: Mod) => any }) {
		module.install(this);
	}
}
	...
	setupEntityComponents(entity: Entity) {
		...
		entity.addComponent(
			new shapez.ItemProcessorComponent({
				inputsPerCharge: 1,
				processorType: shapez.enumItemProcessorTypes.flipper as any,
			})
		);
